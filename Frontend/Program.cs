...
var httpClient = new HttpClient { BaseAddress = new Uri("https://sushicounter.onrender.com/") }; //onrender testing
httpClient.Timeout = TimeSpan.FromSeconds(10); // 10 sekunder timeout på API-kald
